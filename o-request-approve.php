                                    ...
                                    <div class="row p-2 g-3 justify-content-center">
                                        ...
                                        <div class="col-12 col-xxl-10 mt-0">
                                            <div class="row g-2 mt-1 mb-0 justify-content-end">
                                                ...
                                                <?php if($req['req_status'] == "รอดำเนินการ"){ ?>

                                                <div id="approveButton" class="col-12 col-md-3 col-lg-12 col-xl-3">
                                                    <?php $req_id = $req["req_id"];?>
                                                    <?php $officer_id = $_SESSION["RWeb-userID"];?>
                                                    <a class="btn btn-lg btn-primary w-100 text-nowrap" onclick="approveReq('<?php echo $req_id;?>','<?php echo $officer_id;?>')">
